...
const TEAM_MEMBERS = [
  {
    ...
    roleFr: "President d'honneur de l'association Teplo",
    roleUk: "Почесний президент асоціації Teplo",
    bioFr: "Vice-President de l'Association des Anciens Parlementaires des Etats Membres du Conseil de l'Europe",
  ...
  },
  {
    ...
    roleFr: "Vice-presidente de l'association",
  ...
  },
  {
    ...
    bioFr: 'Directeur du Theatre « Na Zhukakh », Kharkiv',
  ...
  },
  {
    ...
    roleFr: "Presidente de l'association",
    roleUk: 'Президент асоціації',
    bioFr: "Refugiee, psychotherapeute, membre de l'association EMDR Europe",
  ...
  },
  {
    ...
    roleFr: 'Coordinatrice du departement de soutien aux blesses',
    roleUk: 'Координатор відділу підтримки постраждалих',
    bioFr: 'Refugiee, art-therapeute, enseignante',
  ...
  },
  {
    ...
    bioFr: 'PhD, psychotherapeute, directrice de la clinique PSYCHE (Ukraine)',
  ...
  },
  {
    ...
    bioFr: "Refugie, chef d'entreprise",
  ...
  },
  {
    ...
    nameFr: 'Yana DUB',
    nameUk: 'Яна ДУБ',
    roleFr: 'Specialiste en communication pour Teplo',
    roleUk: 'Спеціаліст з комунікацій Teplo',
    bioFr: 'Refugiee, specialiste SMM',
